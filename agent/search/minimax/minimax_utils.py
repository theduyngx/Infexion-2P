...
Purpose:
    Utility functions for Minimax and Negamax algorithms, which includes optimization for getting
    all legal moves for a specific agent and other search optimization functionalities such as
    move ordering and dynamic move reductions.

Notes:
    Get all legal moves is optimized for Minimax and Negamax algorithms. It allows agent to choose
